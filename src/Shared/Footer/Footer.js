...
const Footer = () => {
    return (
        <div className='bg-secondary text-white mt-5'>
                    ...
                    <CDBBox display="flex" alignItems="center">
                        <a href="/" className="d-flex align-items-center p-0 text-dark">
                            <img
                                ...
                                width="30px"
                            />
                            <span className=" ml-4 h5 mb-0 me-3 font-weight-bold">Mahbuba</span>
                        </a>
                        <small className="ml-2 ms-3">&copy; Mahbuba, 2022. All rights reserved.</small>
                    </CDBBox>
                    <CDBBox display="flex mt-3 ms-5">
